          ...
          <div className='wrapper'>
            ...
            <div  ref={sectionRef}
                ...
                <div data-aos='zoom-in-right' data-aos-duration="500" className="content relative overflow-hidden rounded-2xl bg-transparent px-5 mx-10 flex flex-col gap-3">
                    <div className="flex flex-col justify-center items-center gap-5 border-double border-2 border-indigo-300 rounded-2xl overflow-hidden w-full h-[200px] max-h-[200px] py-5">
                      {/* Image/Icon */}
                        <DollarSign
