        ...
        <div className="pb-12 md:pb-20">
          ...
          <div className="mx-auto max-w-3xl pb-12 text-center md:pb-20">
            <div className="inline-flex items-center gap-3 pb-3 before:h-px before:w-8 before:bg-linear-to-r before:from-transparent before:to-indigo-200/50 after:h-px after:w-8 after:bg-linear-to-l after:from-transparent after:to-indigo-200/50">
              <span className="inline-flex bg-linear-to-r from-indigo-500 to-indigo-200 bg-clip-text text-transparent text-sm md:text-[1rem]">
            ...
            <p className="text-sm md:text-lg text-indigo-200/65">
          ...
          <Sliders className="relative flex gap-5 overflow-x-scroll md:overflow-x-scroll md:no-scrollbar md:whitespace-nowrap md:scroll-smooth">
            <CarouselNav slides={Slides} />
                {/* Card 1 */}
